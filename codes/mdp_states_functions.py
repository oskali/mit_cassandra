...
from codes.mdp_utils import fit_cv_fold, fit_eval_params
...
def createSamplesRelative(df,  # dataframe: original full dataframe
    ...
    # alpha function
    df_new['alpha_t'] = (df_new['r_t'] - (1-1e-6)) / (df_new['r_t-1'] - (1-1e-6))
    ...
    # cross validation
        ...
        if not randomized:
            ...
            for i in range(cv):
                ...
                for split_fold in GroupKFold(n_splits=3).split(df_cutoff, y=None, groups=df_cutoff['ID_shuffle']):
