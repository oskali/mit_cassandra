...
# def predict_covid(df, start_date, memory = 10, forward_days = 14, split_date = '2020-05-01', day_0 = '2020-05-01', real_GR = False, deterministic = True, r = 30,date_col='date', region_col='state', target_col='cases'):
#     '''
...
def find_best_model_covid(df, start_date, memory = 10, forward_days = 14, split_date = '2020-04-10', day_0 = '2020-04-10', real_GR = False, deterministic = True, r = 1,date_col='date', region_col='state', target_col='cases'):
    ...
    # print("mesa sthn kakia sunarthsh")
    # print(df)
    # print(df[date_col].max())    
    # print("The r is:", r)
    # print("the split date is: ", split_date)
    # print("forward days are: ", forward_days)
    (model_winner,mode_winner,epochs_winner) = get_best_parameters(df, memory, split_date,forward_days, r, date_col)
